...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"RestPHP","description":"The Blazing-Fast, Persistent Application Server & Runtime for PHP powered by Rust","base":"/restphp/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/logo.svg","siteTitle":"RestPHP","nav":[{"text":"Guide","link":"/guide/getting-started"},{"text":"Architecture","link":"/architecture/overview"},{"text":"Laravel Octane","link":"/frameworks/laravel-octane"},{"text":"Benchmarks","link":"/benchmarks/comparison"},{"text":"Roadmap","link":"/roadmap"},{"text":"v0.1.0","items":[{"text":"Changelog","link":"https://github.com/arsyadal/restphp/releases"},{"text":"Contributing","link":"https://github.com/arsyadal/restphp/blob/main/CONTRIBUTING.md"}]}],"sidebar":[{"text":"Get Started","items":[{"text":"Welcome to RestPHP","link":"/guide/what-is-restphp"},{"text":"Getting Started","link":"/guide/getting-started"},{"text":"CLI Reference","link":"/guide/cli-commands"}]},{"text":"Core Runtime","items":[{"text":"Persistent Worker Architecture","link":"/runtime/persistent-workers"},{"text":"Zero Host GC & Determinism","link":"/runtime/zero-host-gc"},{"text":"Request Lifecycle & State Reset","link":"/runtime/state-reset"}]},{"text":"HTTP & SAPI Subsystem","items":[{"text":"Superglobal Mapping","link":"/http/superglobals"},{"text":"Output Buffering & Headers","link":"/http/output-buffering"}]},{"text":"Framework Integrations","items":[{"text":"Laravel & Laravel Octane","link":"/frameworks/laravel-octane"},{"text":"Traditional PHP & Slim","link":"/frameworks/traditional-php"},{"text":"Symfony Framework","link":"/frameworks/symfony"}]},{"text":"Architecture Deep Dive","items":[{"text":"Architectural Blueprint","link":"/architecture/overview"},{"text":"Zend Engine C-FFI","link":"/architecture/zend-ffi"},{"text":"Custom SAPI Bridge (c/sapi.c)","link":"/architecture/custom-sapi"},{"text":"Async Tokio Engine","link":"/architecture/async-engine"}]},{"text":"Performance & Benchmarks","items":[{"text":"RestPHP vs Competitors","link":"/benchmarks/comparison"},{"text":"Benchmark Methodology","link":"/benchmarks/methodology"}]},{"text":"Project & Community","items":[{"text":"Roadmap & Milestones","link":"/roadmap"},{"text":"GitHub Repository","link":"https://github.com/arsyadal/restphp"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/arsyadal/restphp"}],"footer":{"message":"Released under the MIT / Apache-2.0 License. Powered by Rust & Zend Engine.","copyright":"Copyright © 2026 Arsyad Alghital. All rights reserved."},"search":{"provider":"local"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.73suo67Q.js"));
...
<span class="dim">Execution completed in memory in 0.7ms</span>`
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "terminal-wrapper" }, _attrs))} data-v-e5ffaa76><div class="terminal-glow" data-v-e5ffaa76></div><div class="terminal-card" data-v-e5ffaa76><div class="terminal-header" data-v-e5ffaa76><div class="traffic-lights" data-v-e5ffaa76><span class="dot red" data-v-e5ffaa76></span><span class="dot yellow" data-v-e5ffaa76></span><span class="dot green" data-v-e5ffaa76></span></div><div class="tab-list" data-v-e5ffaa76><!--[-->`);
      ssrRenderList(tabs, (tab, index) => {
        _push(`<button class="${ssrRenderClass(["tab-btn", { active: activeTab.value === index }])}" data-v-e5ffaa76>${ssrInterpolate(tab.name)}</button>`);
      });
      _push(`<!--]--></div><button class="copy-btn"${ssrRenderAttr("title", copied.value ? "Copied!" : "Copy to clipboard")} data-v-e5ffaa76>`);
      if (!copied.value) {
        _push(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-e5ffaa76><rect x="9" y="9" width="13" height="13" rx="2" ry="2" data-v-e5ffaa76></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" data-v-e5ffaa76></path></svg>`);
      } else {
        _push(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#22c55e" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-v-e5ffaa76><polyline points="20 6 9 17 4 12" data-v-e5ffaa76></polyline></svg>`);
      }
      _push(`<span data-v-e5ffaa76>${ssrInterpolate(copied.value ? "Copied" : "Copy")}</span></button></div><div class="terminal-body" data-v-e5ffaa76><div class="command-line" data-v-e5ffaa76><span class="prompt" data-v-e5ffaa76>$</span><span class="command" data-v-e5ffaa76>${ssrInterpolate(currentTab.value.command)}</span></div><div class="terminal-output" data-v-e5ffaa76>${currentTab.value.outputHtml ?? ""}</div></div></div></div>`);
    };
  }
};
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/HeroTerminal.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const HeroTerminal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e5ffaa76"]]);
const _sfc_main = {
  __name: "BenchmarkChart",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    const metrics = {
      ...
      latency: {
        ...
        items: [
          ...
          { name: "Nginx + PHP-FPM", version: "8.4 NTS", value: 42, displayValue: "42.0 ms", color: "#64748b", isWinner: false }
        ]
      }
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "benchmark-container" }, _attrs))} data-v-38fbf0b1><div class="benchmark-card" data-v-38fbf0b1><div class="benchmark-header" data-v-38fbf0b1><div data-v-38fbf0b1><h3 class="bench-title" data-v-38fbf0b1>Serving a Laravel 11 Application</h3><p class="bench-subtitle" data-v-38fbf0b1> JSON API endpoint · 1,000 concurrent connections · 64 vCPU AMD EPYC · medians of 5 </p></div><div class="metric-tabs" data-v-38fbf0b1><!--[-->`);
      ssrRenderList(metrics, (metric, key) => {
        _push(`<button class="${ssrRenderClass(["metric-tab-btn", { active: activeMetric.value === key }])}" data-v-38fbf0b1>${ssrInterpolate(metric.name)}</button>`);
      });
      _push(`<!--]--></div></div><div class="chart-body" data-v-38fbf0b1><div class="legend-note" data-v-38fbf0b1><span class="note-pill" data-v-38fbf0b1>${ssrInterpolate(currentMetric.value.note)}</span></div><div class="bars-wrapper" data-v-38fbf0b1><!--[-->`);
      ssrRenderList(currentMetric.value.items, (item) => {
        _push(`<div class="${ssrRenderClass(["bar-row", { winner: item.isWinner }])}" data-v-38fbf0b1><div class="runtime-info" data-v-38fbf0b1><span class="runtime-name" data-v-38fbf0b1>${ssrInterpolate(item.name)}</span><span class="runtime-version" data-v-38fbf0b1>${ssrInterpolate(item.version)}</span></div><div class="bar-track" data-v-38fbf0b1><div class="bar-fill" style="${ssrRenderStyle({
          width: getBarWidth(item.value, currentMetric.value),
          backgroundColor: item.color
        })}" data-v-38fbf0b1></div></div><div class="runtime-value" data-v-38fbf0b1><span class="val-number" data-v-38fbf0b1>${ssrInterpolate(item.displayValue)}</span>`);
        if (item.isWinner) {
          _push(`<span class="winner-badge" data-v-38fbf0b1>${ssrInterpolate(currentMetric.value.winnerTag)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
      });
      _push(`<!--]--></div><div class="axis-line" data-v-38fbf0b1><!--[-->`);
      ssrRenderList(currentMetric.value.ticks, (tick) => {
        _push(`<span data-v-38fbf0b1>${ssrInterpolate(tick)}</span>`);
      });
      _push(`<!--]--></div></div><div class="benchmark-footer" data-v-38fbf0b1><span data-v-38fbf0b1>Standard wrk -t12 -c1000 benchmark script included in repository.</span><a href="/benchmarks/comparison" class="reproduce-link" data-v-38fbf0b1> Reproduce this benchmark → </a></div></div></div>`);
    };
  }
};
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/BenchmarkChart.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const BenchmarkChart = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-38fbf0b1"]]);
const RawTheme = {
  extends: theme,
  enhanceApp({ app }) {
